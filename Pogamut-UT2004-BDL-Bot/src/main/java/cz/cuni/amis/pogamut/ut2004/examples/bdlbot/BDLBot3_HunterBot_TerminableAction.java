...
@AgentScoped
public class BDLBot3_HunterBot_TerminableAction extends UT2004BDLBotController<UT2004Bot> {
	...
	public InputStream getBDLPlanXMLStream() {
		return getResourceStream("cz/cuni/amis/pogamut/ut2004/examples/bdlbot/03-HunterBot-TerminableAction.xml");
	}
    
    @SuppressWarnings("unchecked")
	public static void main(String args[]) throws PogamutException {
        new UT2004BotRunner(     // class that wraps logic for bots executions, suitable to run single bot in single JVM
        		BDLBot3_HunterBot_TerminableAction.class,   // which UT2004BotController it should instantiate
