...
@AgentScoped
public class BDLBot1_JumpBot extends UT2004BDLBotController<UT2004Bot> {

	@Override
	public Initialize getInitializeCommand() {
		return super.getInitializeCommand().setName("JumpBot");
	}
	
	@Override
	public InputStream getBDLPlanXMLStream() {
		return getResourceStream("cz/cuni/amis/pogamut/ut2004/examples/bdlbot/01-JumpBot.xml");
	}
    
    @SuppressWarnings("unchecked")
	public static void main(String args[]) throws PogamutException {
        new UT2004BotRunner(     // class that wraps logic for bots executions, suitable to run single bot in single JVM
        		BDLBot1_JumpBot.class,   // which UT2004BotController it should instantiate
